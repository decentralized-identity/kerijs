...
//   const sig = key64uToKey(signature);
//   const vk = key64uToKey(verkey);
...
// //   let values = [];
// //   for (let label in labels) extractElementValues(ked[label], values);
// // }
...
// //     });
// //   } else {
// //     for (k in element) {extractElementValues(element[k], values);}
// //   }
